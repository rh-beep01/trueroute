...
const SOCIAL_LINKS = {
  instagram: 'https://instagram.com/roamify.life',
  facebook: 'https://facebook.com/roamify.life',
  pinterest: 'https://pinterest.com/roamify',
...
function renderSocialFooter() {
  return `
    <div style="margin-top:24px; padding-top:20px; border-top:1px solid #E2E8F0; text-align:center;">
      <p style="margin:0 0 10px 0; font-size:12px; font-weight:700; color:#64748B; text-transform:uppercase; letter-spacing:0.5px;">Follow Our Family Travel Guides</p>
      <div style="display:inline-flex; gap:12px; align-items:center; justify-content:center;">
        <a href="${SOCIAL_LINKS.instagram}" style="display:inline-block; background:#F1F5F9; color:#0F172A; text-decoration:none; font-size:12px; font-weight:600; padding:6px 12px; border-radius:6px; margin:0 4px;">📸 Instagram</a>
        <a href="${SOCIAL_LINKS.facebook}" style="display:inline-block; background:#F1F5F9; color:#0F172A; text-decoration:none; font-size:12px; font-weight:600; padding:6px 12px; border-radius:6px; margin:0 4px;">📘 Facebook</a>
        <a href="${SOCIAL_LINKS.pinterest}" style="display:inline-block; background:#F1F5F9; color:#0F172A; text-decoration:none; font-size:12px; font-weight:600; padding:6px 12px; border-radius:6px; margin:0 4px;">📌 Pinterest</a>
        <a href="${SOCIAL_LINKS.website}" style="display:inline-block; background:#F1F5F9; color:#0F172A; text-decoration:none; font-size:12px; font-weight:600; padding:6px 12px; border-radius:6px; margin:0 4px;">🌐 Website</a>
      </div>
    </div>
  `;
}
          ...
          <tr>
            <td style="padding:0 36px 32px 36px; text-align:center;">
              <p style="margin:0 0 12px 0; font-size:13px; color:#64748B;">
                Need to add extra details or adjust dates? Simply reply directly to this email or reach us at <a href="mailto:hello@roamify.life" style="color:#E05A47; font-weight:600; text-decoration:none;">hello@roamify.life</a>.
              </p>
            </td>
          </tr>
      ...
      <td align="center">
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px; width:100%; background:#FFFFFF; border-radius:16px; overflow:hidden; border:1px solid #E2E8F0; box-shadow:0 4px 20px rgba(15,23,42,0.06);">
              ...
              <div style="background:#F8FAFC; border:1px solid #E2E8F0; border-radius:12px; padding:20px;">
                ...
                <table width="100%" cellspacing="0" cellpadding="8" style="font-size:13px; border-collapse:collapse;">
                  ...
                  <tr>
                    ...
                    <td style="color:#0F172A;">PDF Guide + Interactive Map sent to <strong>${clientEmail}</strong></td>
                  </tr>
                </table>
          ...
          <tr>
            <td style="padding:0 36px 32px 36px; text-align:center;">
              <p style="margin:0 0 12px 0; font-size:13px; color:#64748B;">
                Have questions or need to make an adjustment while we build your plan? Simply reply to this email or contact us at <a href="mailto:hello@roamify.life" style="color:#2E6F40; font-weight:600; text-decoration:none;">hello@roamify.life</a>.
              </p>
            </td>
          </tr>
