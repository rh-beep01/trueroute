...
function renderSocialFooter() {
  return `
    <div style="margin-top:24px; padding-top:20px; border-top:1px solid #E2E8F0; text-align:center;">
      <p style="margin:0 0 14px 0; font-size:12px; font-weight:700; color:#64748B; text-transform:uppercase; letter-spacing:0.5px;">Connect With Us</p>
      <table role="presentation" cellspacing="0" cellpadding="0" style="margin:0 auto;">
        <tr>
          ...
          <!-- Email -->
          <td style="padding:0 6px;">
            <a href="${SOCIAL_LINKS.email}" style="display:inline-block; text-decoration:none; text-align:center;">
              <img src="https://roamify.life/logos/email.svg" width="36" height="36" alt="Email" style="display:block; border-radius:10px; border:0;" />
              <span style="display:block; font-size:10px; font-weight:600; color:#64748B; margin-top:4px;">Email Us</span>
            </a>
          </td>
        </tr>
      </table>
            ...
            <td style="padding:0 36px 8px 36px;">
              <div style="background:#FFF7ED; border:1px solid #FED7AA; border-radius:8px; padding:10px 14px; text-align:center;">
                <p style="margin:0; font-size:11px; color:#92400E;">
                  ⚠️ <strong>This is a no-reply email</strong> — please do not reply to this address (orders@roamify.life). Messages sent here will not be received.
                </p>
              </div>
            </td>
          </tr>
