...
export default function FloatingChat() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 font-sans">
      {/* Chat Popup Box */}
      {isOpen && (
        <div className="mb-3 w-[340px] sm:w-[380px] bg-white rounded-2xl shadow-2xl border border-slate-200/80 overflow-hidden animate-fadeInUp">
          {/* Header */}
          <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="relative">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-400 to-teal-600 flex items-center justify-center text-lg shadow-sm">
                  ✈️
                </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <span className="text-[11px] text-emerald-300 font-medium">Online · Ready to help</span>
                </div>
              </div>
            </div>
            <button
          ...
          <div className="p-4 bg-slate-50 space-y-3">
            ...
            <div className="bg-white p-3.5 rounded-2xl rounded-tl-sm border border-slate-200/80 shadow-sm text-xs leading-relaxed text-slate-700">
              👋 <strong>Hi there!</strong> Have questions about our family itineraries, toddler nap windows, or senior accessibility?
              <br /><br />
              Tap below to chat with our human travel planning team directly:
            </div>
            ...
            <div className="space-y-2 pt-1">
              ...
              <a
                ...
                className="group flex items-center justify-between p-3.5 bg-white hover:bg-emerald-50/80 border border-slate-200 hover:border-emerald-500 rounded-xl transition-all shadow-sm hover:shadow"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[11px] text-emerald-600 font-medium">Instant replies · Active</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3.5 bg-white/70 border border-slate-200/70 rounded-xl opacity-60 cursor-not-allowed">
                <div className="flex items-center gap-3">
              ...
              <div className="flex items-center justify-between p-3.5 bg-white/70 border border-slate-200/70 rounded-xl opacity-60 cursor-not-allowed">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-[#F58529] via-[#DD2A7B] to-[#8134AF] text-white flex items-center justify-center shadow-sm">
                  ...
                  <div className="text-left">
                    <p className="font-semibold text-xs text-slate-700">Instagram</p>
          ...
          <div className="px-4 py-2.5 bg-slate-100/80 border-t border-slate-200/60 text-center">
            <p className="text-[10px] text-slate-400 font-medium flex items-center justify-center gap-1">
              <span>🔒</span> Direct human support · Guaranteed response
            </p>
          </div>
        </div>
      )}
      ...
      <button
        ...
        className="group relative flex items-center gap-2.5 bg-[#25D366] hover:bg-[#20ba59] text-white font-bold py-3.5 px-5 rounded-full shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-200 ease-out"
      ...
      >
        ...
        <span className="text-sm font-bold tracking-tight">Need Help? Chat</span>
      </button>
    </div>
  );
}